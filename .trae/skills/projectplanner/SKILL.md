...
参见 [templates.md](templates.md) 中的 plan.md 模板。
...
参见 [templates.md](templates.md) 中的 progress.md 模板。
...
参见 [templates.md](templates.md) 中的 FAQ.md 模板。
...
参见 [templates.md](templates.md) 中的 learning.md 模板。
...
- 根据 [templates.md](templates.md) 中的 AGENTS.md 模板生成
- 将模板中的 `[项目名]` 替换为实际项目名
- 放在**项目根目录**（不是 `docs/` 目录）
...
所有文档模板参见 [reference/templates.md](reference/templates.md)。